...
#' generated by function \code{\link{fit_ht}} or \code{\link{fit_wln}}.  When applied to a \code{\link{fit_wln}}
#' object, the contour estimation makes use of the importance sampling technique proposed in Huseby et. al. (2014)
